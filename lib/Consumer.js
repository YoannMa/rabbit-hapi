...
class Consumer extends Emittery {
    ...
    constructor(connection, options) {
        ...
        this.configurations.consumer.options.consumerTag = this.configurations.consumer.options.consumerTag || Uuid();
    ...
    async close() {
        ...
        await this.consumer.cancel(this.configurations.consumer.options.consumerTag);
